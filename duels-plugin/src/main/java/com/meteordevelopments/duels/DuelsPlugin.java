...
public class DuelsPlugin extends JavaPlugin implements Duels, LogSource {
    ...
    // Added from the new code (Spigot resource id)
    ...
    private boolean unload() {
        ...
        // Unregister all extension listeners that aren't using the method Duels#registerListener
    ...
    public static String getPrefix() {
        // Keep the previous plugin's prefix style
    ...
    private void initLoadables() {
        ...
        // Keep hook manager initialised but not added to loadables, matching previous behaviour
